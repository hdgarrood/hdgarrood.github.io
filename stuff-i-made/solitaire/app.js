...
(function(exports) {
  ...
  var moveCursorInDirection = function (dir) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Solitaire.Web line 370, column 3 - line 378, column 34: " + [ dir.constructor.name ]);
      };
  };
  ...
  var genericUIState = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 320, column 8 - line 320, column 52: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var genericQuery = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 297, column 8 - line 297, column 52: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var genericDirection = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 308, column 8 - line 308, column 56: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return DUp.value;
      };
  ...
  var advanceOrReset = function (g) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 382, column 3 - line 394, column 1: " + [ v.constructor.name ]);
  };
      ...
      var render = function (st) {
          ...
          var renderSelection = function (v) {
              ...
              return go((function () {
                  ...
                  throw new Error("Failed pattern match at Solitaire.Web line 251, column 14 - line 255, column 35: " + [ v.value0.constructor.name ]);
              })());
          };
          ...
          var classesFor = function (display) {
              return Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)(Data_Array.snoc([ "card" ])((function () {
                  if (display instanceof Solitaire_Web_Positioning.FaceUp) {
                      ...
                      throw new Error("Failed pattern match at Solitaire.Web line 265, column 15 - line 268, column 13: " + [ v.constructor.name ]);
                  };
                  ...
                  throw new Error("Failed pattern match at Solitaire.Web line 263, column 11 - line 273, column 5: " + [ display.constructor.name ]);
              })()));
          };
          ...
          var notFocusedReminder = [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("unfocused") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Click here to play") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Controls:") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("hjkl [move selection]") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Space [fix selection]") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("g [select top card from waste pile]") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("a [draw into waste pile]") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("qwertyu [move selection to tableau]") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("d [discard selection]") ]) ]) ];

...
(function(exports) {
  ...
  var fromSeed = function ($156) {
      return fromDeck(Solitaire_Deck.fromSeed($156));
  };                                               
...
(function(exports) {
  ...
  var moveCursorInDirection = function (dir) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Solitaire.Web line 369, column 3 - line 377, column 34: " + [ dir.constructor.name ]);
      };
  };
  var initialState = new Data_Tuple.Tuple(new Selection({
      ix: Solitaire_Tableaux.ixFromInt(0), 
      size: 1
  }), Solitaire_Game.fromSeed(Test_QuickCheck_LCG.mkSeed(0)));
  var genericUIState = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 319, column 8 - line 319, column 52: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var genericQuery = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 296, column 8 - line 296, column 52: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var genericDirection = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 307, column 8 - line 307, column 56: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return DUp.value;
      };
  ...
  var advanceOrReset = function (g) {
      ...
      throw new Error("Failed pattern match at Solitaire.Web line 381, column 3 - line 393, column 1: " + [ v.constructor.name ]);
  };
  var adjustWith = function (next) {
      return function (game) {
          ...
          var adjustIndex = function ($copy_next1) {
              return function ($copy_v) {
                  var $tco_var_next1 = $copy_next1;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(next1, v) {
                      var tableau = Solitaire_Tableaux.get(v.ix)((Data_Newtype.unwrap(Solitaire_Game.newtypeGame)(game)).tableaux);
                      var nextCsr = {
                          ix: next1(v.ix), 
                          size: v.size
                  ...
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_next1, $copy_v);
                  };
                  return $tco_result;
              };
          };
          return function ($177) {
              return adjustIndex(next)(adjustSize($177));
          };
      };
  };
  ...
  var ui = (function () {
      var render = function (st) {
          ...
          var px = function ($178) {
              return CSS_Size.px(Data_Int.toNumber($178));
          };
          var renderSelection = function (v) {
              ...
              return go((function () {
                  ...
                  throw new Error("Failed pattern match at Solitaire.Web line 250, column 14 - line 254, column 35: " + [ v.value0.constructor.name ]);
              })());
          };
          ...
          var classesFor = function (display) {
              return Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)(Data_Array.snoc([ "card" ])((function () {
                  if (display instanceof Solitaire_Web_Positioning.FaceUp) {
                      ...
                      throw new Error("Failed pattern match at Solitaire.Web line 264, column 15 - line 267, column 13: " + [ v.constructor.name ]);
                  };
                  ...
                  throw new Error("Failed pattern match at Solitaire.Web line 262, column 11 - line 272, column 5: " + [ display.constructor.name ]);
              })()));
          };
      ...
      var $$eval = (function () {
          ...
          var discardSelection = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Tuple.snd))(function (v) {
              return onlyWaiting(function (csr$prime) {
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Profunctor_Strong.first(Data_Profunctor_Strong.strongFn)(Data_Function["const"](Selection.create(adjustWith(Solitaire_Prelude.succOrLoop(Solitaire_Tableaux.boundedEnumTableauIndex))(v)((function () {
                      ...
                      throw new Error("Failed pattern match at Solitaire.Web line 121, column 11 - line 125, column 38: " + [ csr$prime.constructor.name ]);
                  })())))));
              });
          });
          var applyMove = function (move) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Tuple.snd))(function (v) {
                  ...
                  throw new Error("Failed pattern match at Solitaire.Web line 129, column 7 - line 138, column 27: " + [ v1.constructor.name ]);
              });
          };
          return function (v) {
              ...
              throw new Error("Failed pattern match at Solitaire.Web line 67, column 5 - line 94, column 18: " + [ v.constructor.name ]);
          };
      })();

...
(function(exports) {
  ...
  var primeFactors = (function () {
      ...
      var nextDivisor = function (v) {
          if (v === 2) {
              return 3;
          };
          return v + 2 | 0;
      };
      var go = function ($copy_factors) {
          return function ($copy_v) {
              return function ($copy_v1) {
                  var $tco_var_factors = $copy_factors;
                  var $tco_var_v = $copy_v;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(factors, v, v1) {
                      if (v1 === 1) {
                          $tco_done = true;
                          return Data_List.reverse(factors);
                      };
                      var $10 = v1 % v === 0;
                      if ($10) {
                          $tco_var_factors = new Data_List_Types.Cons(v, factors);
                          $tco_var_v = v;
                          $copy_v1 = v1 / v | 0;
                          return;
                      };
                      $tco_var_factors = factors;
                      $tco_var_v = nextDivisor(v);
                      $copy_v1 = v1;
                      return;
                  };
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_factors, $tco_var_v, $copy_v1);
                  };
                  return $tco_result;
              };
          };
      ...
      return function ($12) {
          return go(Data_List_Types.Nil.value)(2)(sanitize($12));
      };
  })();
  var isPrime = function (n) {
      return Data_Eq.eq(Data_List_Types.eqList(Data_Eq.eqInt))(primeFactors(n))(Data_List.singleton(n));
  };
  exports["primeFactors"] = primeFactors;
  exports["isPrime"] = isPrime;
})(PS["Data.ModularArithmetic.Primality"] = PS["Data.ModularArithmetic.Primality"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Data_List_Types = PS["Data.List.Types"];
  var Data_Maybe = PS["Data.Maybe"];
  var Data_ModularArithmetic = PS["Data.ModularArithmetic"];
  var Data_ModularArithmetic_Primality = PS["Data.ModularArithmetic.Primality"];
  var Data_Monoid = PS["Data.Monoid"];
  var Data_NonEmpty = PS["Data.NonEmpty"];
  var Data_Ord = PS["Data.Ord"];
  var Data_Ordering = PS["Data.Ordering"];
  ...
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];        
  var RuleEvalZero = (function () {
      function RuleEvalZero() {

      };
      RuleEvalZero.value = new RuleEvalZero();
      return RuleEvalZero;
  })();
  var RuleEvalOne = (function () {
      function RuleEvalOne() {

      };
      RuleEvalOne.value = new RuleEvalOne();
      return RuleEvalOne;
  })();
  var RuleModulo = (function () {
      function RuleModulo() {

      };
      RuleModulo.value = new RuleModulo();
      return RuleModulo;
  })();
  var RuleMultiplicative = (function () {
      function RuleMultiplicative() {

      };
      RuleMultiplicative.value = new RuleMultiplicative();
      return RuleMultiplicative;
  })();
  var RulePower = (function () {
      function RulePower() {

      };
      RulePower.value = new RulePower();
      return RulePower;
  })();
  var RuleEvalMinusOne = (function () {
      function RuleEvalMinusOne() {

      };
      RuleEvalMinusOne.value = new RuleEvalMinusOne();
      return RuleEvalMinusOne;
  })();
  var RuleEvalTwo = (function () {
      function RuleEvalTwo() {

      };
      RuleEvalTwo.value = new RuleEvalTwo();
      return RuleEvalTwo;
  })();
  var RuleReciprocity = (function () {
      function RuleReciprocity() {

      };
      RuleReciprocity.value = new RuleReciprocity();
      return RuleReciprocity;
  })();
  var Expr = (function () {
      function Expr(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Expr.create = function (value0) {
          return function (value1) {
              return new Expr(value0, value1);
          };
      };
      return Expr;
  })();
  var single = function (t) {
      return new Expr(1, Control_Applicative.pure(Data_List_Types.applicativeList)(t));
  };
  var semigroupExpr = new Data_Semigroup.Semigroup(function (v) {
      return function (v1) {
          return new Expr(v.value0 * v1.value0 | 0, Data_Semigroup.append(Data_List_Types.semigroupList)(v.value1)(v1.value1));
      };
  });
  var renderExpr = function (f) {
      var litStr = function (i) {
          if (i === 1) {
              return "";
          };
          if (i === -1) {
      ...
      return function (v) {
          ...
          return litStr(v.value0) + Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(f)(v.value1);
      };
  };
  var primePowerFactors = (function () {
      var bunchUp = function ($164) {
          return Data_Functor.map(Data_List_Types.functorList)(Data_Foldable.product(Data_List_Types.foldableNonEmptyList)(Data_Semiring.semiringInt))(Data_List.group(Data_Eq.eqInt)($164));
      };
      return function ($165) {
          return bunchUp(Data_ModularArithmetic_Primality.primeFactors($165));
      };
  })();
  var monoidExpr = new Data_Monoid.Monoid(function () {
      return semigroupExpr;
  }, new Expr(1, Data_List_Types.Nil.value));
  var lit = function (i) {
      return new Expr(i, Data_List_Types.Nil.value);
  };
  var isFullyReduced = function (v) {
      if (v.value1 instanceof Data_List_Types.Nil) {
          return true;
      };
      return false;
  };
  var genericReductionRule = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof RuleEvalZero) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      if (x instanceof RuleEvalOne) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
      };
      if (x instanceof RuleModulo) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
      };
      if (x instanceof RuleMultiplicative) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value))));
      };
      if (x instanceof RulePower) {
      ...
      if (x instanceof RuleEvalMinusOne) {
      ...
      if (x instanceof RuleReciprocity) {
      ...
      throw new Error("Failed pattern match at LegendreSymbols line 89, column 8 - line 89, column 64: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return RuleEvalZero.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return RuleEvalOne.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return RuleModulo.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inl))) {
          return RuleMultiplicative.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inl)))) {
          return RulePower.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inl))))) {
          return RuleEvalMinusOne.value;
      };
      ...
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0.value0.value0.value0 instanceof Data_Generic_Rep.Inr)))))) {
          return RuleReciprocity.value;
      };
      throw new Error("Failed pattern match at LegendreSymbols line 89, column 8 - line 89, column 64: " + [ x.constructor.name ]);
  });
  var showReductionRule = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericReductionRule)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "RuleEvalZero";
  ...
  var by = Data_Function.flip(Data_Tuple.Tuple.create);
  var asPrimePower = function (n) {
      var v = Data_ModularArithmetic_Primality.primeFactors(n);
      if (v instanceof Data_List_Types.Nil) {
          return Data_Maybe.Nothing.value;
      };
      if (v instanceof Data_List_Types.Cons) {
          var $126 = Data_Foldable.all(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v1) {
              return v1 === v.value0;
          })(v.value1);
          if ($126) {
              return new Data_Maybe.Just(new Data_Tuple.Tuple(v.value0, Data_List.length(v.value1) + 1 | 0));
          };
          return Data_Maybe.Nothing.value;
      };
      throw new Error("Failed pattern match at LegendreSymbols line 201, column 3 - line 207, column 21: " + [ v.constructor.name ]);
  };
  var reduce = function (v) {
      if (!(0 <= v.value0 && v.value0 < v.value1)) {
          return by(single(new Data_Tuple.Tuple(emod(v.value0)(v.value1), v.value1)))(RuleModulo.value);
      };
      if (v.value0 === 0) {
          return by(lit(0))(RuleEvalZero.value);
      };
      if (v.value0 === 1) {
          return by(lit(1))(RuleEvalOne.value);
      };
      if (v.value0 === (v.value1 - 1 | 0)) {
          var e = (function () {
              var $130 = v.value1 % 4 === 1;
              if ($130) {
                  return lit(1);
              };
              return lit(-1 | 0);
          })();
          return by(e)(RuleEvalMinusOne.value);
      };
      if (v.value0 === 2) {
          var r = v.value1 % 8;
          var e = (function () {
          ...
          return by(e)(RuleEvalTwo.value);
      };
      if (Data_ModularArithmetic_Primality.isPrime(v.value0)) {
          var e = (function () {
              var $132 = v.value1 % 4 === 3 && v.value0 % 4 === 3;
              if ($132) {
                  return Data_Semigroup.append(semigroupExpr)(lit(-1 | 0))(single(new Data_Tuple.Tuple(v.value1, v.value0)));
              };
              return single(new Data_Tuple.Tuple(v.value1, v.value0));
          })();
          return by(e)(RuleReciprocity.value);
      };
      var v1 = function (v2) {
          if (Data_Boolean.otherwise) {
              var e = Data_Foldable.foldMap(Data_List_Types.foldableList)(monoidExpr)(function (b) {
                  return single(new Data_Tuple.Tuple(b, v.value1));
              })(primePowerFactors(v.value0));
              return by(e)(RuleMultiplicative.value);
          };
          throw new Error("Failed pattern match at LegendreSymbols line 122, column 1 - line 122, column 52: " + [ v.constructor.name ]);
      };
      var $139 = asPrimePower(v.value0);
      if ($139 instanceof Data_Maybe.Just) {
          var e = (function () {
              var $140 = $139.value0.value1 % 2 === 0;
              if ($140) {
                  return lit(1);
              };
              return single(new Data_Tuple.Tuple($139.value0.value0, v.value1));
          })();
          return by(e)(RulePower.value);
      };
      return v1(true);
  };
  var reduceExpr = function (v) {
      if (v.value0 === 0) {
          return new Data_Either.Left(0);
      };
      if (v.value1 instanceof Data_List_Types.Nil) {
          return new Data_Either.Left(v.value0);
      };
      if (v.value1 instanceof Data_List_Types.Cons) {
          return new Data_Either.Right(Data_Functor.map(Data_Tuple.functorTuple)(function (v1) {
              return Data_Semigroup.append(semigroupExpr)(v1)(new Expr(v.value0, v.value1.value1));
          })(reduce(v.value1.value0)));
      };
      throw new Error("Failed pattern match at LegendreSymbols line 177, column 14 - line 183, column 44: " + [ v.constructor.name ]);
  };
  var reduceN = function (n) {
      return function (expr) {
          var go = function ($copy_acc) {
              return function ($copy_n1) {
                  return function ($copy_expr1) {
                      var $tco_var_acc = $copy_acc;
                      var $tco_var_n1 = $copy_n1;
                      var $tco_done = false;
                      var $tco_result;
                      function $tco_loop(acc, n1, expr1) {
                          var $160 = n1 <= 0;
                          if ($160) {
                              $tco_done = true;
                              return acc;
                          };
                          var v = reduceExpr(expr1);
                          if (v instanceof Data_Either.Right) {
                              $tco_var_acc = new Data_List_Types.Cons(v.value0, acc);
                              $tco_var_n1 = n1 - 1 | 0;
                              $copy_expr1 = Data_Tuple.snd(v.value0);
                              return;
                          };
                          if (v instanceof Data_Either.Left) {
                              $tco_done = true;
                          ...
                          throw new Error("Failed pattern match at LegendreSymbols line 251, column 9 - line 255, column 16: " + [ v.constructor.name ]);
                      };
                      while (!$tco_done) {
                          $tco_result = $tco_loop($tco_var_acc, $tco_var_n1, $copy_expr1);
                      };
                      return $tco_result;
                  };
              };
          ...
          return {
              initial: expr,
              steps: Data_List.reverse(go(Data_List_Types.Nil.value)(n)(expr))
          };
      };
  };
  exports["Expr"] = Expr;
  exports["RuleEvalZero"] = RuleEvalZero;
  exports["RuleEvalOne"] = RuleEvalOne;
  exports["RuleModulo"] = RuleModulo;
  exports["RuleMultiplicative"] = RuleMultiplicative;
  exports["RulePower"] = RulePower;
  exports["RuleEvalMinusOne"] = RuleEvalMinusOne;
  exports["RuleEvalTwo"] = RuleEvalTwo;
  exports["RuleReciprocity"] = RuleReciprocity;
  ...
  exports["isFullyReduced"] = isFullyReduced;
  exports["primePowerFactors"] = primePowerFactors;
  exports["asPrimePower"] = asPrimePower;
  exports["exprToString"] = exprToString;
  exports["renderExpr"] = renderExpr;
  exports["reduceN"] = reduceN;
  exports["genericReductionRule"] = genericReductionRule;
  exports["showReductionRule"] = showReductionRule;
  exports["semigroupExpr"] = semigroupExpr;
  exports["monoidExpr"] = monoidExpr;
})(PS["LegendreSymbols"] = PS["LegendreSymbols"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var LegendreSymbols = PS["LegendreSymbols"];
  var Prelude = PS["Prelude"];        
  ...
  var ReplaceInput = (function () {
      function ReplaceInput(value0) {
          this.value0 = value0;
      };
      ReplaceInput.create = function (value0) {
          return new ReplaceInput(value0);
      };
      return ReplaceInput;
  })();
  var UpdateNumerator = (function () {
      function UpdateNumerator(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateNumerator.create = function (value0) {
          return function (value1) {
              return new UpdateNumerator(value0, value1);
          };
      };
      return UpdateNumerator;
  })();
  var UpdateDenominator = (function () {
      function UpdateDenominator(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateDenominator.create = function (value0) {
          return function (value1) {
              return new UpdateDenominator(value0, value1);
          };
      };
      return UpdateDenominator;
  })();
  var stateFromInput = function (input) {
      return {
          input: input,
          reductions: 0,
          numerator: Data_Show.show(Data_Show.showInt)(Data_Tuple.fst(input)),
          denominator: Data_Show.show(Data_Show.showInt)(Data_Tuple.snd(input)),
          validationError: Data_Maybe.Nothing.value
      };
  };
  var updateInput = function (state) {
      var newInput = Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Numerator must be an integer")(Data_Int.fromString(state.numerator)))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Denominator must be an integer")(Data_Int.fromString(state.denominator)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Data_Either.bindEither)(Control_Applicative.when(Data_Either.applicativeEither)(!Data_ModularArithmetic_Primality.isPrime(v1) || v1 === 2)(Control_Monad_Error_Class.throwError(Control_Monad_Error_Class.monadThrowEither)("Denominator must be an odd prime")))(function () {
      ...
      return Data_Either.either(function (err) {
          ...
          $11.validationError = new Data_Maybe.Just(err);
          return $11;
      })(stateFromInput)(newInput);
  };
  var component = (function () {
      var render = function (state) {
          var renderValidationError = function (msg) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(msg) ]);
          };
          var reductions = LegendreSymbols.reduceN(state.reductions)(LegendreSymbols.single(state.input));
          var workingPlain = Data_String.joinWith("\x0a  = ")(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_List_Types.Cons.create(LegendreSymbols.exprToString(reductions.initial))(Data_Functor.map(Data_List_Types.functorList)(function (v) {
              return LegendreSymbols.exprToString(v.value1) + ("     (by " + (Data_String.drop(4)(Data_Show.show(LegendreSymbols.showReductionRule)(v.value0)) + ")"));
          })(reductions.steps))));
          var isComplete = (function (v) {
              return Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(v)(new Data_Maybe.Just(true));
          })(Data_Functor.map(Data_Maybe.functorMaybe)(function ($33) {
              return LegendreSymbols.isFullyReduced(Data_Tuple.snd($33));
          })(Data_List.last(reductions.steps)));
          var nextButton = Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("Next"), Halogen_HTML_Properties.enabled(!isComplete), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Advance.create)) ])([ Halogen_HTML_Core.text("Next") ]);
          var inputForm = Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.title("Numerator"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Data_Tuple.fst(state.input))), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateNumerator.create)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.title("Denominator"), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(Data_Tuple.snd(state.input))), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdateDenominator.create)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("Go"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ReplaceInput.create)) ])([ Halogen_HTML_Core.text("Go") ]) ])(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(renderValidationError)(state.validationError))));
          var displayPanel = Halogen_HTML_Elements.pre_([ Halogen_HTML_Core.text(workingPlain) ]);
          return Halogen_HTML_Elements.div_([ inputForm, displayPanel, nextButton ]);
      };
      var initialState = stateFromInput(new Data_Tuple.Tuple(30, 47));
      var $$eval = function (v) {
          if (v instanceof Advance) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $18.reductions = s.reductions + 1 | 0;
                  return $18;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof ReplaceInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(updateInput))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof UpdateNumerator) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $23 = {};
                  for (var $24 in s) {
                  ...
                  $23.numerator = v.value0;
                  return $23;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof UpdateDenominator) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $28 = {};
                  for (var $29 in s) {
                  ...
                  $28.denominator = v.value0;
                  return $28;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at Component line 135, column 10 - line 147, column 12: " + [ v.constructor.name ]);
      };
  ...
  exports["stateFromInput"] = stateFromInput;
  exports["updateInput"] = updateInput;
  exports["Advance"] = Advance;
  exports["ReplaceInput"] = ReplaceInput;
  exports["UpdateNumerator"] = UpdateNumerator;
  exports["UpdateDenominator"] = UpdateDenominator;
  exports["component"] = component;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement(selector))(function (v) {
          if (v instanceof Data_Maybe.Just) {
              return Data_Functor["void"](Control_Monad_Aff.functorAff)(Halogen_VDom_Driver.runUI(Component.component)(Data_Unit.unit)(v.value0));
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.error("Unable to find #app element"));
          };
          throw new Error("Failed pattern match at Main line 20, column 3 - line 24, column 51: " + [ v.constructor.name ]);
      });
  }));
